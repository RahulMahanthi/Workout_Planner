...
const CreateEntry = ({ setOpen }) => {
    ...
    const { data } = useFetch(`https://workout-planner-1-8yuq.onrender.com/api/entries/fetchMealsAndRoutines/${user._id}`)
    ...
    const handleClick = async (e) => {
        ...
        try {
            await axios.post('https://workout-planner-1-8yuq.onrender.com/api/entries/', newEntry, {
